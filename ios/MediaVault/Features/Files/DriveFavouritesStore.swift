...
// Agent: READS/WRITES UserDefaults `mediavault_favourite_files`; USED context menu + Home-style picks later.
@Observable
@MainActor
final class DriveFavouritesStore {
    static let shared = DriveFavouritesStore()

    private static let storageKey = "mediavault_favourite_files"
