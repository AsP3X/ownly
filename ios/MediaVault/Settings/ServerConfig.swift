...
// Human: Persists the MediaVault API base URL used by auth and future drive features.
...
private enum Keys {
    static let host = "mediavault.serverConfig.host"
    static let port = "mediavault.serverConfig.port"
    static let useHTTPS = "mediavault.serverConfig.useHTTPS"
}
