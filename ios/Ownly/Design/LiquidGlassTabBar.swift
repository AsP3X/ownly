...
// Agent: READS selectedTab Binding; CALLS onUpload; USES glassPanel glassButtonPrimary OwnlyColors; iOS 26 glassEffect via design modifiers.
struct LiquidGlassTabBar: View {
    ...
    private func tabButton(for tab: MainTab) -> some View {
        ...
        return Button {
            ...
            .foregroundStyle(isSelected ? OwnlyColors.primary400 : OwnlyColors.neutral400)
            .frame(minWidth: 72)
    ...
    private var uploadButton: some View {
        Button(action: onUpload) {
            Image(systemName: "plus")
                ...
                .shadow(color: OwnlyColors.primary600.opacity(0.35), radius: 12, y: 6)
        }
        .buttonStyle(.plain)
