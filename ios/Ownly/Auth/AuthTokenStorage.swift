...
// Agent: kSecClassGenericPassword service com.Ownly.auth account loginToken; save getToken clear use SecItemAdd CopyMatching Delete.

enum AuthTokenStorage {
    private static let service = "com.Ownly.auth"
