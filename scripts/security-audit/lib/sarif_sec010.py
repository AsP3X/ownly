# Human: SARIF 2.1.0 export for SEC-010 findings (CI ingestion).
...
from .constants_sec010 import AUDIT_ID, REMEDIATION_SEC010
                ...
                "invocations": [
                    {
                        ...
                        "message": {
                            "text": REMEDIATION_SEC010 if report.verdict == "vulnerable" else "ok"
                        },
                    }
                ],
            }
