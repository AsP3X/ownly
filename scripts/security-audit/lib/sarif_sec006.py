# Human: SARIF 2.1.0 export for SEC-006 findings (CI ingestion).
...
from .constants_sec006 import AUDIT_ID, REMEDIATION_SEC006
                ...
                "invocations": [
                    {
                        ...
                        "message": {
                            "text": REMEDIATION_SEC006 if report.verdict == "vulnerable" else "ok"
                        },
                    }
                ],
            }
