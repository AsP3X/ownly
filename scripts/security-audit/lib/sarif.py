# Human: SARIF 2.1.0 export for SEC-001 findings (CI ingestion).
...
from .constants import AUDIT_ID, REMEDIATION_SEC001
                ...
                "invocations": [
                    {
                        ...
                        "message": {"text": REMEDIATION_SEC001 if report.verdict == "vulnerable" else "ok"},
                    }
                ],
            }
        ],
