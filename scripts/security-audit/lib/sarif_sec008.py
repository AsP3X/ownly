# Human: SARIF 2.1.0 export for SEC-008 findings (CI ingestion).
...
from .constants_sec008 import AUDIT_ID, REMEDIATION_SEC008
                ...
                "invocations": [
                    {
                        ...
                        "message": {
                            "text": REMEDIATION_SEC008 if report.verdict == "vulnerable" else "ok"
                        },
                    }
                ],
            }
