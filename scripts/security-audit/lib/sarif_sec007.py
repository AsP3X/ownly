# Human: SARIF 2.1.0 export for SEC-007 findings (CI ingestion).
...
from .constants_sec007 import AUDIT_ID, REMEDIATION_SEC007
                ...
                "invocations": [
                    {
                        ...
                        "message": {
                            "text": REMEDIATION_SEC007 if report.verdict == "vulnerable" else "ok"
                        },
                    }
                ],
            }
