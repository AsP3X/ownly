# Human: SARIF 2.1.0 export for SEC-003 findings (CI ingestion).
...
from .constants_sec003 import AUDIT_ID, REMEDIATION_SEC003
                ...
                "invocations": [
                    {
                        ...
                        "message": {
                            "text": REMEDIATION_SEC003 if report.verdict == "vulnerable" else "ok"
                        },
                    }
                ],
            }
