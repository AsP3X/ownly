# Human: SARIF 2.1.0 export for SEC-005 findings (CI ingestion).
...
from .constants_sec005 import AUDIT_ID, REMEDIATION_SEC005
                ...
                "invocations": [
                    {
                        ...
                        "message": {
                            "text": REMEDIATION_SEC005 if report.verdict == "vulnerable" else "ok"
                        },
                    }
                ],
            }
