# Human: SARIF 2.1.0 export for SEC-011 findings (CI ingestion).
...
from .constants_sec011 import AUDIT_ID, REMEDIATION_SEC011
                ...
                "invocations": [
                    {
                        ...
                        "message": {
                            "text": REMEDIATION_SEC011 if report.verdict == "vulnerable" else "ok"
                        },
                    }
                ],
            }
