# Human: SARIF 2.1.0 export for SEC-004 findings (CI ingestion).
...
from .constants_sec004 import AUDIT_ID, REMEDIATION_SEC004
                ...
                "invocations": [
                    {
                        ...
                        "message": {
                            "text": REMEDIATION_SEC004 if report.verdict == "vulnerable" else "ok"
                        },
                    }
                ],
            }
