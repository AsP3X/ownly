# Human: SARIF 2.1.0 export for SEC-002 findings (CI ingestion).
...
from .constants_sec002 import AUDIT_ID, REMEDIATION_SEC002
                ...
                "invocations": [
                    {
                        ...
                        "message": {
                            "text": REMEDIATION_SEC002 if report.verdict == "vulnerable" else "ok"
                        },
                    }
                ],
            }
