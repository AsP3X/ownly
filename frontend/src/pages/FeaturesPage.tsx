...
const processingSteps = [
  {
    ...
    description:
      "Drive files are sent as plaintext bytes so Nebular zstd can compress them (NOSI indexed blobs). Video HLS paths encrypt segments before upload.",
    visual: (
      <>
  ...
  },
  {
    ...
    description:
      "Nebular applies fast upload zstd (default level 3) and can recompress legacy blobs to NOSI at a stronger maintenance level in the background.",
    visual: (
      <>
