// Human: shadcn context menu primitives built on Base UI — supports nested submenus.
// Agent: EXPORTS ContextMenu* parts; root Content omits side for cursor anchoring; SubmenuTrigger uses safePolygon.
