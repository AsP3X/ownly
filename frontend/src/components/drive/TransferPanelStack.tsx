...
export function TransferPanelStack() {
  ...
  return (
    <div
      className="pointer-events-none fixed bottom-[calc(7.5rem+env(safe-area-inset-bottom))] right-4 z-50 flex w-[min(100vw-2rem,22.5rem)] flex-col gap-3 transition-[gap] duration-300 lg:bottom-4"
      aria-live="polite"
    >
      {hasStorageMigration ? (
