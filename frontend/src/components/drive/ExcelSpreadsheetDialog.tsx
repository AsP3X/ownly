...
export function ExcelSpreadsheetDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={handleDialogOpenChange}>
      <DialogContent
        className="flex max-h-[calc(100dvh-1rem)] w-full max-w-[calc(100vw-2rem)] flex-col gap-0 overflow-hidden border-0 bg-transparent p-4 shadow-none ring-0 sm:max-w-[calc(100vw-2rem)]"
        overlayClassName="bg-[#0A0A10]/80 backdrop-blur-2xl"
      ...
      >
        ...
        {/* Agent: WIDTH only — sm:max-w override; height/layout unchanged from original centered dialog. */}
        <div
